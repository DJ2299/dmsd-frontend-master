...
import { 
  addBookingSaga, collectPaymentSaga, editBookingSaga, getBookingSaga, deleteBookingSaga 
} from './booking/booking';
import { 
   getVisitSaga, editVisitSaga, deleteVisitSaga
...
export function* watchVehicle() {
  yield all([
    ...
    takeEvery(actionLabels.DELETE_VEHICLE_SAGA, deleteVehicleSaga),
  ]);
}
...
export function* watchBooking() {
  yield all([
    ...
    takeEvery(actionLabels.DELETE_BOOKING_SAGA, deleteBookingSaga),
  ]);
}
...
export function* watchServiceRecords() {
  yield all([
    ...
    takeEvery(actionLabels.EDIT_VISIT_SAGA, editVisitSaga),
    takeEvery(actionLabels.DELETE_VISIT_SAGA, deleteVisitSaga),
  ]);
}
